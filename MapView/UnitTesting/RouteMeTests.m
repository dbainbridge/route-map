...
- (void)testScreenCoordinatesPacificNorthwest
{
	...
	CGPoint point1 = [mapView convertCoordinateToPoint:coord];
	
	coord.longitude -= .125;
	CGPoint point2 = [mapView convertCoordinateToPoint:coord];
	
	coord.longitude -= .125;
	CGPoint point3 = [mapView convertCoordinateToPoint:coord];
