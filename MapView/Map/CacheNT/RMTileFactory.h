...
// 
//  Added to Route-Map under existing terms for Route-Me, permission granted
//  by author Darcy Brockbank May 20, 2010
...
// you request an image from the tile factory, and if it is able to send it
